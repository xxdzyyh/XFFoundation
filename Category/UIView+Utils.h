...
#define XFStatusBarHeight [[UIApplication sharedApplication] statusBarFrame].size.height
#define XFNavBarHeight self.navigationController.navigationBar.frame.size.height
#define XFTopHeight (XFStatusBarHeight + XFNavBarHeight)

CGFloat autoSizeScale(void);
CGFloat autoSizeScaleX(void);
CGFloat autoSizeScaleY(void);
...
/**
 ...
 @param colors NSArray<CGColorRef>
 */
